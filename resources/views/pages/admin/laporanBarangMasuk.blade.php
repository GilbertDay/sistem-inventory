    ...
    <div class="flex flex-col w-full gap-4 px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
        ...
        <div class="card bg-[#90caf96c]">
            ...
            <div class="card-body" id="table-stok">
                <form action="{{ route('laporanBarangMasuk') }}" method="GET">
                    ...
                    <div class="flex flex-wrap items-end gap-3 mb-3 text-black">
                        <div>
                            ...
                            <input
                                ...
                                type="date"
                                name="tanggal_awal"
                                value="{{ request('tanggal_awal', optional($barangMasuk->first())->tanggal ?? '') }}"
                                required>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="date"
                                name="tanggal_akhir"
                                value="{{ request('tanggal_akhir', optional($barangMasuk->last())->tanggal ?? '') }}"
                                required>
                        </div>
